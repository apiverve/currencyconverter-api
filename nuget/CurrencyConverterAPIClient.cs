...
namespace APIVerve.API.CurrencyConverter
{
    ...
    /// <summary>
    /// Client for the CurrencyConverter API
    /// </summary>
...
#endif
    {
        ...
        {
            { "value", new ValidationRule { Type = "number", Required = true, Min = 0 } },
            { "from", new ValidationRule { Type = "string", Required = true } },
            { "to", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public CurrencyConverterAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CurrencyConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CurrencyConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(CurrencyConverterQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CurrencyConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CurrencyConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CurrencyConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CurrencyConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CurrencyConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
