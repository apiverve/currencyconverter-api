...
// Request contains the parameters for the Currency Converter API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"value": {Type: "number", Required: true, Min: float64Ptr(0)},
...
// ResponseData contains the data returned by the Currency Converter API.
