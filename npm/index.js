...
class currencyconverterWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/currencyconverter');
        }
        ...
        this.validationRules = {"value":{"type":"number","required":true,"min":0},"from":{"type":"string","required":true},"to":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/currencyconverter`);
        }
    }
...
module.exports = currencyconverterWrapper;
