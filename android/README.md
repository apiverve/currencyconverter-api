# Currency Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:currencyconverter-api:1.1.14'
}
```
...
```java
import com.apiverve.currencyconverter.CurrencyConverterAPIClient;
import com.apiverve.currencyconverter.APIResponse;
import com.apiverve.currencyconverter.APIException;

// Initialize the client
CurrencyConverterAPIClient client = new CurrencyConverterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("value", 1);
    parameters.put("from", "USD");
    parameters.put("to", "EUR");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/currencyconverter](https://docs.apiverve.com/ref/currencyconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/currencyconverter](https://docs.apiverve.com/ref/currencyconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/currencyconverter-api/issues)
