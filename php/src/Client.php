...
namespace APIVerve\Currencyconverter;
...
/**
 * Client for the Currency Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://currencyconverter.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/currencyconverter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CurrencyconverterClient] {$message}\n";
        }
    }
}
